...
#
# Benchmarking 9f17d6de-c0c8-4732-97c0-9a933582c741.southcentralus.azurecontainer.io (be patient)...INFO: POST header ==
# ---
# POST /score HTTP/1.0
# Content-length: 812
# Content-type: application/json
# Authorization: Bearer Agb3D23IygXXXXXXXXXXXXXXXXXXXXXXXXX
# Host: 9f17d6de-c0c8-4732-97c0-9a933582c741.southcentralus.azurecontainer.io
...
# Server Hostname:        9f17d6de-c0c8-4732-97c0-9a933582c741.southcentralus.azurecontainer.io
# Server Port:            80
#
# Document Path:          /score
...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer REPLACE_WITH_KEY' http://9f17d6de-c0c8-4732-97c0-9a933582c741.southcentralus.azurecontainer.io/score
